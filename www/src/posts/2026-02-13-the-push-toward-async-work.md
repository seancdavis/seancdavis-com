...
1. Work synchronously until the MVP has a real definition
...
The goal is to get to the point where you can work asynchronously. Because _then_ you can be more effective. Then you can move on to the next thing that requires focus. Then you can let agents run with multiple complementary ideas in parallel.
