...
[Gmail](http://gmail.com) works with labels instead of folders for organizing your email messages. If it's easier for you, you can think of *labels* as *folders, where a message can live in more than one folder*. If you think back to the post about [categories and tags](/categories-and-tags-explained.html), labels would be like tags.
...
Let's step back for a second. Remember the post on [archiving Gmail messages](/when-should-i-archive-my-gmail-messages.html)? Good. So, assuming you are following those general guidelines on archiving, you'd be archiving **anything with a chance of being referenced again.**
